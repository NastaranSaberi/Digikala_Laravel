...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
    <div class="container-fluid">
      <a class="navbar-brand" href="#">
        <img src="<?php echo e(asset('/Images/logo.png')); ?>" alt="logo" height="24">
      </a>
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <form class="d-flex">
          ...
          <img src="<?php echo e(asset('/Images/0.png')); ?>" class="img-fluid" alt="pic_1" style="width: 142px; height: 44px;">
        </form>
      </div>
    </div>
...
<?php /**PATH /Users/nastaran/Helloworld/resources/views/navbar.blade.php ENDPATH**/ ?>