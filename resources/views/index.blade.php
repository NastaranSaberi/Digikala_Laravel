...
<nav class="navbar navbar-expand-lg navbar-light " style="background-color: white;">
  ...
  <div class="container-fluid">
    <div class="container mt-3">
      <div class="row">
        <div class="col_12">
          <img src="{{ asset('/Images/1.gif') }}" class="img-fluid " alt="pic_1" style="border-radius: 15px;">
        </div>
      </div>
      <div class="row mt-3">
          ...
          <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel"
            ...
            <div class="carousel-inner mb-3" style="border-radius: 15px;">
              <div class="carousel-item active">
                <img src="{{ asset('/Images/9.jpeg') }}" class="d-block w-100" alt="pic_9">
              </div>
              <div class="carousel-item">
                <img src="{{ asset('/Images/8.jpeg') }}" class="d-block w-100" alt="pic_8">
              </div>
              <div class="carousel-item">
                <img src="{{ asset('/Images/5.jpeg') }}" class="d-block w-100" alt="pic_5">
              </div>
              <div class="carousel-item">
                <img src="{{ asset('/Images/3.jpeg') }}" class="d-block w-100" alt="pic_3">
              </div>
              <div class="carousel-item">
                <img src="{{ asset('/Images/6.jpeg') }}" class="d-block w-100" alt="pic_6">
              </div>
              <div class="carousel-item">
                <img src="{{ asset('/Images/7.jpeg') }}" class="d-block w-100" alt="pic_7">
              </div>
              <div class="carousel-item">
                <img src="{{ asset('/Images/4.jpeg') }}" class="d-block w-100" alt="pic_4">
              </div>
              <div class="carousel-item">
                <img src="{{ asset('/Images/2.jpeg') }}" class="d-block w-100" alt="pic_2">
              </div>
            </div>
        ...
        <div class="col-lg-4 col-md-4 col-sm-12">
          <div class="row">
            <img src="{{ asset('/Images/11.jpeg') }}" class="img-fluid " alt="pic_11" style="border-radius: 25px;">
          </div>
          <div class="row " style="margin-top: 12px;">
            <img src="{{ asset('/Images/10.jpeg') }}" class="img-fluid " alt="pic_10" style="border-radius: 25px;">
          </div>
        </div>
      </div>
    </div>
        ...
        <div class="container ">
          <div class="row ">
            <div class="col-lg d-none d-lg-block d-xl-block d-xl-block mb-3">
              <img src="{{ asset('/Images/12.png') }}" class="img-fluid" alt="pic_12">
            ...
            <div class="col-lg col-md-6 col-sm-12 mb-3">
              <div class="card" style="border-radius: 10px;">
                <img src="{{ asset('/Images/13.jpeg') }}" class="card-img-top" alt="pic_13" style="border-radius: 10px;">
            ...
            <div class="col-lg col-md-6 col-sm-12 mb-3">
              <div class="card" style="border-radius: 10px;">
                <img src="{{ asset('/Images/14.jpeg') }}" class="card-img-top" alt="pic_14" style="border-radius: 10px;">
                <div class="card-body text-center">
            ...
            <div class="col-lg col-md-6 col-sm-12 mb-3">
              <div class="card" style="border-radius: 10px;">
                <img src="{{ asset('/Images/15.jpeg') }}" class="card-img-top" alt="pic_15" style="border-radius: 10px;">
                <div class="card-body text-center">
            ...
            <div class="col-lg col-md-6 col-sm-12 mb-3">
              <div class="card" style="border-radius: 10px;">
                <img src="{{ asset('/Images/16.jpeg') }}" class="card-img-top" alt="pic_16" style="border-radius: 10px;">
                <div class="card-body text-center">
    ...
    <div class="container py-4 mt-3">
      <div class="row">
        <div class="col-lg-3 col-md-6 col-sm-12 mb-3">
          <img src="{{ asset('/Images/17.jpeg') }}" class="img-fluid w-100" alt="pic_17" style="border-radius: 15px;">
        </div>
        <div class="col-lg-3 col-md-6 col-sm-12 mb-3">
          <img src="{{ asset('/Images/18.jpeg') }}" class="img-fluid w-100" alt="pic_18" style="border-radius: 15px;">
        </div>
        <div class="col-lg-3 col-md-6 col-sm-12 mb-3">
          <img src="{{ asset('/Images/19.jpeg') }}" class="img-fluid w-100" alt="pic_19" style="border-radius: 15px;">
        </div>
        <div class="col-lg-3 col-md-6 col-sm-12 mb-3">
          <img src="{{ asset('/Images/20.jpeg') }}" class="img-fluid w-100" alt="pic_20" style="border-radius: 15px;">
        </div>
      </div>
    </div>
    ...
    <div class="row bg-Success py-4 mt-3">
      <div class="col">
        <div class="container ">
          <div class="row ">
            <div class="col-lg d-none d-lg-block d-xl-block d-xl-block mb-3">
              <img src="{{ asset('/Images/21.png') }}" class="img-fluid" alt="pic_21">
              <button type="button" class="btn btn-outline-light rounded-3">مشاهده همه</button>
            </div>
            <div class="col-lg col-md-6 col-sm-12 mb-3">
              <div class="card" style="border-radius: 10px;">
                <img src="{{ asset('/Images/22.jpeg') }}" class="card-img-top" alt="pic_22" style="border-radius: 10px;">
                <div class="card-body text-center">
            ...
            <div class="col-lg col-md-6 col-sm-12 mb-3">
              <div class="card" style="border-radius: 10px;">
                <img src="{{ asset('/Images/23.jpeg') }}" class="card-img-top" alt="pic_23" style="border-radius: 10px;">
                <div class="card-body text-center">
            ...
            <div class="col-lg col-md-6 col-sm-12 mb-3">
              <div class="card" style="border-radius: 10px;">
                <img src="{{ asset('/Images/24.jpeg') }}" class="card-img-top" alt="pic_24" style="border-radius: 10px;">
                <div class="card-body text-center">
            ...
            <div class="col-lg col-md-6 col-sm-12 mb-3">
              <div class="card" style="border-radius: 10px;">
                <img src="{{ asset('/Images/25.jpeg') }}" class="card-img-top" alt="pic_25" style="border-radius: 10px;">
                <div class="card-body text-center">
    ...
    <div class="container">
      <div class="row py-4 mt-3">
        <div class="col">
          <img src="{{ asset('/Images/26.jpeg') }}" class="img-fluid " alt="pic_26" style="border-radius: 15px;">
        </div>
        <div class="col">
          <img src="{{ asset('/Images/27.jpeg') }}" class="img-fluid " alt="pic_27" style="border-radius: 15px;">
        </div>
      </div>
    </div>
            ...
            <div class="row ">
              <div class="col-lg col-sm-12">
                <div class="card  border-0">
                  <img src="{{ asset('/Images/28.jpeg') }}" class="card-img-top p-3" alt="pic_28">
                  <div class="card-body">
                    <h5 class="card-title text-center">پتو</h5>
                    <p class="card-text ">پتو گلبافت کد 500S سایز 220×160 سانتی متر</p>
                    <div class="text-end mt-5">
              ...
              <div class="col-lg col-sm-12">
                <div class="card  border-0">
                  <img src="{{ asset('/Images/29.jpeg') }}" class="card-img-top p-3" alt="pic_29">
                  <div class="card-body">
                    <h5 class="card-title text-center">پتو</h5>
                    <p class="card-text ">پتو گلبافت کد 500S سایز 220×160 سانتی متر</p>
                    <div class="text-end mt-5">
              ...
              <div class="col-lg col-sm-12">
                <div class="card  border-0">
                  <img src="{{ asset('/Images/30.jpeg') }}" class="card-img-top p-3" alt="pic_30">
                  <div class="card-body">
                    <h5 class="card-title text-center">پتو</h5>
                    <p class="card-text ">پتو گلبافت کد 500S سایز 220×160 سانتی متر</p>
                    <div class="text-end mt-5">
              ...
              <div class="col-lg col-sm-12">
                <div class="card border-0">
                  <img src="{{ asset('/Images/31.jpeg') }}" class="card-img-top p-3" alt="pic_31">
                  <div class="card-body">
                    <h5 class="card-title text-center">پتو</h5>
                    <p class="card-text ">پتو گلبافت کد 500S سایز 220×160 سانتی متر</p>
                    <div class="text-end mt-5">
              ...
              <div class="col-lg col-sm-12">
                <div class="card border-0">
                  <img src="{{ asset('/Images/32.jpeg') }}" class="card-img-top p-3" alt="pic_32">
                  <div class="card-body">
                    <h5 class="card-title text-center">پتو</h5>
                    <p class="card-text ">پتو گلبافت کد 500S سایز 220×160 سانتی متر</p>
                    <div class="text-end mt-5">
          ...
          <div class="col-lg-2 col-sm-12 ">
            <div class="card border-info mt-2" style=" border-radius: 10px;">
              ...
              <div class="card-body " style="margin-bottom: 30px;">
                <img src="{{ asset('/Images/33.jpeg') }}" class="card-img-top" alt="pic_33">
          ...
          <div class="col-md-9 col-sm-12 shadow bg-white" style="border-radius: 10px;">
            ...
            <div class="row ">
              <div class="col-lg col-sm-2">
                <div class="card border-0">
                  <img src="{{ asset('/Images/41.jpeg') }}" class="card-img-top" alt="pic_41">
                  <div class="card-body">
              ...
              <div class="col-lg col-sm-2">
                <div class="card border-0">
                  <img src="{{ asset('/Images/37.jpeg') }}" class="card-img-top p-3" alt="pic_37">
                  <div class="card-body">
                    <h5 class="card-title text-center">دستمال کاغذی</h5>
                    <p class="card-text ">دستمال توالت مدل B Side بسته 8 عددی</p>
                    <div class="text-end mt-5">
              ...
              <div class="col-lg col-sm-2">
                <div class="card border-0">
                  <img src="{{ asset('/Images/38.jpeg') }}" class="card-img-top p-3" alt="pic_38">
                  <div class="card-body">
                    <h5 class="card-title text-center">دستمال کاغذی</h5>
                    <p class="card-text ">دستمال توالت مدل B Side بسته 8 عددی</p>
                    <div class="text-end mt-5">
              ...
              <div class="col-lg col-sm-2">
                <div class="card border-0">
                  <img src="{{ asset('/Images/39.jpeg') }}" class="card-img-top p-3" alt="pic_39">
                  <div class="card-body">
                    <h5 class="card-title text-center">دستمال کاغذی</h5>
                    <p class="card-text ">دستمال توالت مدل B Side بسته 8 عددی</p>
                    <div class="text-end mt-5">
              ...
              <div class="col-lg col-sm-2">
                <div class="card border-0">
                  <img src="{{ asset('/Images/40.jpeg') }}" class="card-img-top p-3" alt="pt-40">
                  <div class="card-body">
                    <h5 class="card-title text-center">دستمال کاغذی</h5>
                    <p class="card-text ">دستمال توالت مدل B Side بسته 8 عددی</p>
                    <div class="text-end mt-5">
  ...
  <div class="container py-4 ">
    <div class="row">
      <div class="col-lg-3 col-md-6 col-sm-12 mb-3">
        <img src="{{ asset('/Images/42.jpeg') }}" class="img-fluid w-100" alt="pic-42" style="border-radius: 15px;">
      </div>
      <div class="col-lg-3 col-md-6 col-sm-12 mb-3">
        <img src="{{ asset('/Images/43.jpeg') }}" class="img-fluid w-100" alt="pic-43" style="border-radius: 15px;">
      </div>
      <div class="col-lg-3 col-md-6 col-sm-12 mb-3 ">
        <img src="{{ asset('/Images/44.jpeg') }}" class="img-fluid w-100" alt="pic-44" style="border-radius: 15px;">
      </div>
      <div class="col-lg-3 col-md-6 col-sm-12 mb-3 ">
        <img src="{{ asset('/Images/45.jpeg') }}" class="img-fluid w-100" alt="pic-45" style="border-radius: 15px;">
      </div>
    </div>
  </div>
      ...
      <div class="col-lg-12 col-sm-12 shadow-sm p-3 bg-body" style="border-radius: 10px;">
        ...
        <div class="row ">
          <div class="col-lg col-md-12 col-sm-12">
            <div class="card border-0">
              <img src="{{ asset('/Images/46.jpeg') }}" class="card-img-top p-3" alt="pic_46">
              <div class="card-body">
          ...
          <div class="col-lg col-md-12 col-sm-12">
            <div class="card border-0">
              <img src="{{ asset('/Images/47.jpeg') }}" class="card-img-top p-3" alt="pic_47">
              <div class="card-body">
                <h5 class="card-title text-center">ماسک</h5>
                <p class="card-text ">ماسک صورت شب بایو آکوا مدل pomegranate حجم 120 میلی لیتر</p>
                <div class="text-end mt-5">
          ...
          <div class="col-lg col-md-12 col-sm-12">
            <div class="card border-0">
              <img src="{{ asset('/Images/48.jpeg') }}" class="card-img-top p-3" alt="pt-48">
              <div class="card-body">
                <h5 class="card-title text-center">ماسک</h5>
                <p class="card-text ">ماسک صورت شب بایو آکوا مدل pomegranate حجم 120 میلی لیتر</p>
                <div class="text-end mt-5">
          ...
          <div class="col-lg col-md-12 col-sm-12">
            <div class="card border-0">
              <img src="{{ asset('/Images/49.jpeg') }}" class="card-img-top p-3" alt="pic_49">
              <div class="card-body">
                <h5 class="card-title text-center">ماسک</h5>
                <p class="card-text ">ماسک صورت شب بایو آکوا مدل pomegranate حجم 120 میلی لیتر</p>
                <div class="text-end mt-5">
          ...
          <div class="col-lg col-md-12 col-sm-12">
            <div class="card border-0">
              <img src="{{ asset('/Images/50.jpeg') }}" class="card-img-top p-3" alt="pic_50">
              <div class="card-body">
                <h5 class="card-title text-center">ماسک</h5>
                <p class="card-text ">ماسک صورت شب بایو آکوا مدل pomegranate حجم 120 میلی لیتر</p>
                <div class="text-end mt-5">
          ...
          <div class="col-lg-12 col-sm-12 shadow-sm p-4 bg-body" style="border-radius: 10px ;width: 2200px">
            <div class="mt-2 ">
              ...
              <div class="row ">
                <div class="col-lg col-md-12 col-sm-12">
                  <div class="card border-0">
                    <img src="{{ asset('/Images/52.jpeg') }}" class="card-img-top p-3" alt="pic_52">
                  </div>
                </div>
                <div class="col-lg col-md-12 col-sm-12">
                  <div class="card  border-0">
                    <img src="{{ asset('/Images/51.png') }}" class="card-img-top p-3" alt="pic-51">
                  </div>
                </div>
                <div class="col-lg col-md-12 col-sm-12">
                  <div class="card border-0">
                    <img src="{{ asset('/Images/53.jpeg') }}" class="card-img-top p-3" alt="pic-53">
                  </div>
                </div>
                <div class="col-lg col-md-12 col-sm-12">
                  <div class="card border-0">
                    <img src="{{ asset('/Images/54.jpeg') }}" class="card-img-top p-3" alt="pic-54">
                  </div>
                </div>
                <div class="col-lg col-md-12 col-sm-12">
                  <div class="card border-0">
                    <img src="{{ asset('/Images/55.jpeg') }}" class="card-img-top p-3" alt="pic_55">
                  </div>
                </div>
              </div>
            </div>
  ...
  <div class="container mt-3">
    <div class="row">
      <div class="col_lg-12 ">
        <img src="{{ asset('/Images/36.jpeg') }}" class="img-fluid " alt="" style="border-radius: 15px;">
      </div>
    </div>
  </div>
  </div>
